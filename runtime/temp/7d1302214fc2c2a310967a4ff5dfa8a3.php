<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\data\web\fastadmin\public/../application/admin\view\index\login.html";i:1575558774;s:61:"D:\data\web\fastadmin\application\admin\view\common\meta.html";i:1572536366;s:63:"D:\data\web\fastadmin\application\admin\view\common\script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <img src="<?php echo rtrim('/', '/'); ?>/index1.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/', '/'); ?>/index1.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
