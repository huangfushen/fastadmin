<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\data\web\fastadmin\public/../application/admin\view\volunteer\volunte\add.html";i:1577347881;s:64:"D:\data\web\fastadmin\application\admin\view\layout\default.html";i:1572536367;s:61:"D:\data\web\fastadmin\application\admin\view\common\meta.html";i:1572536366;s:63:"D:\data\web\fastadmin\application\admin\view\common\script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-service_times" data-rule="required" class="form-control" name="row[service_times]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Integral'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-integral" data-rule="required" class="form-control" name="row[integral]" type="number" value="0">
        </div>
    </div>
